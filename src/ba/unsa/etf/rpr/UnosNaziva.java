    ...
    public void OK(ActionEvent actionEvent) {
        if(!n){
            ...
            alert.show();
                ...
                Drzava d;
                d=GeografijaDAO.getInstance().nadjiDrzavu(naziv.getText());
                if(d==null){
                    Alert alert = new Alert(Alert.AlertType.ERROR);
                    alert.setTitle("GRESKA");
                    ...
                    alert.setTitle("Ispis podataka o drzavi");
                    alert.setHeaderText(String.valueOf(d));
                    alert.show();
                }
            }
            Stage stage = (Stage) dugme.getScene().getWindow();
